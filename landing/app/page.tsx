        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8 mb-6 sm:mb-8">
            ...
            <div>
              ...
              <p className="text-xs" style={{ color: '#8fa87e' }}>
                Made with <span style={{ color: '#b86f4c' }}>❤️</span> by turtles.
              </p>
            </div>

            {/* Center: Quick links - hidden on mobile, shown on tablet+ */}
            <div className="hidden sm:block">
              <h4 className="text-xs sm:text-sm font-semibold mb-3 uppercase tracking-wider" style={{ color: '#1a1815' }}>Quick Links</h4>
              <ul className="space-y-1.5 text-xs sm:text-sm">
                <li>
                  <a
                    ...
                    style={{ color: '#4a5f3b' }}
                    onMouseEnter={(e) => (e.currentTarget.style.color = '#b86f4c')}
                    onMouseLeave={(e) => (e.currentTarget.style.color = '#4a5f3b')}
                  >
                    Home
                  </a>
                </li>
            ...
            {/* Right: Social & external - hidden on mobile, shown on tablet+ */}
            <div className="hidden lg:block">
              <h4 className="text-xs sm:text-sm font-semibold mb-3 uppercase tracking-wider" style={{ color: '#1a1815' }}>Community</h4>
              <ul className="space-y-1.5 text-xs sm:text-sm">
                <li>
                  <a
                    href="https://github.com/yourusername/agentic"
          ...
          {/* Divider */}
          <div style={{ borderTop: '1px solid rgba(74, 95, 59, 0.15)', margin: '1rem 0' }} />

          {/* Bottom section: Copyright and badges */}
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
            ...
            <div className="flex flex-wrap items-center justify-center sm:justify-end gap-2">
              <a
                ...
                style={{
                  borderColor: 'rgba(74, 95, 59, 0.25)',
                  backgroundColor: 'rgba(74, 95, 59, 0.06)',
                  color: '#4a5f3b',
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.backgroundColor = 'rgba(74, 95, 59, 0.12)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.backgroundColor = 'rgba(74, 95, 59, 0.06)';
                }}
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full border text-xs transition-colors duration-150"
                style={{
                  borderColor: 'rgba(184, 111, 76, 0.25)',
                  backgroundColor: 'rgba(184, 111, 76, 0.06)',
                  color: '#b86f4c',
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.backgroundColor = 'rgba(184, 111, 76, 0.12)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.backgroundColor = 'rgba(184, 111, 76, 0.06)';
                }}
              >
                <span>🤖</span>
                <span className="font-semibold hidden sm:inline">Claude</span>
              </a>

              <div
                className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full border text-xs"
                style={{
                  borderColor: 'rgba(143, 168, 126, 0.25)',
                  backgroundColor: 'rgba(143, 168, 126, 0.06)',
                  color: '#8fa87e',
                }}
              >
                <span>📝</span>
                <span className="font-semibold hidden sm:inline">MIT</span>
              </div>
            </div>
          </div>
        </div>
