  ...
  return (
    <div className="w-full text-[#2d2a26] font-sans" style={{ backgroundColor: '#faf8f5' }}>
      ...
      <section id="what-it-does" className="relative w-full bg-gradient-to-b from-black to-slate-950 py-20 px-6">
        ...
        {/* Subtle accent blur */}
        <div className="absolute top-1/2 right-0 w-80 h-80 bg-teal-500/5 rounded-full blur-3xl opacity-50" />
      ...
      <section id="how-it-works" className="relative w-full bg-black py-20 px-6 overflow-hidden">
        {/* Background grid pattern */}
        <div
          className="absolute inset-0 opacity-5"
          style={{
        ...
        {/* Subtle accent blur */}
        <div className="absolute top-0 left-1/4 w-80 h-80 bg-emerald-500/5 rounded-full blur-3xl opacity-50" />
