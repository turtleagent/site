...
<CardGroup cols={2}>
  ...
  <Card title="Layer 2: SubTurtles">
    Autonomous background workers that execute scoped coding tasks from state files in `.superturtle/subturtles/&lt;name&gt;/`.
  </Card>
</CardGroup>
...
<Steps>
  ...
  <Step title="Keep state explicit">
    Before spawn, write `.superturtle/subturtles/&lt;name&gt;/CLAUDE.md` with Current Task, End Goal, and Backlog.
  </Step>
