...
- **Extended thinking:** Keywords like `think`, `ultrathink`, or `think hard` increase reasoning effort
...
<Steps>
  <Step title="Clone + open agent">
    Open this repo in Claude Code or Codex.
  </Step>
  <Step title="Start guided onboarding">
    Prompt: `Set up Super Turtle for me.`
    The onboarding flow guides BotFather and user ID steps for you.
  </Step>
  <Step title="Use Quickstart">
    Follow the [Quickstart](/quickstart) page for the exact setup flow.
  </Step>
</Steps>
