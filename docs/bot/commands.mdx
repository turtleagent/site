...
| `/teleport` | none | Moves Telegram control to an E2B remote runtime |
| `/home` | none | Returns Telegram control to your local PC runtime after teleport |
...
- `/home` is most useful after `/teleport`; when you are already local it replies that the turtle is already home.
