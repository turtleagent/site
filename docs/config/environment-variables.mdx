...
```bash
DASHBOARD_PORT=46321
```

Default: stable token-derived port in the `46000-46999` range. This avoids collisions when multiple local Super Turtle instances run on one machine.
