...
flowchart TD
    ...
    ST1 --> R[(Repository)]
    ST2 --> R
    ST1 --> S1[.superturtle/subturtles A/CLAUDE.md]
    ST2 --> S2[.superturtle/subturtles B/CLAUDE.md]

    J[.superturtle/cron-jobs.json] --> B
...
- Per-worker state in `.superturtle/subturtles/<name>/CLAUDE.md`.
...
- Check-ins review worker progress and only surface meaningful updates.
